(function (factory) {
    ...
    var AstObject = /** @class */ (function () {
        ...
        AstObject.prototype.toLiteral = function (mapper) {
            ...
            var result = {};
            try {
                for (var _b = (0, tslib_1.__values)(this.obj), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var _d = (0, tslib_1.__read)(_c.value, 2), key = _d[0], expression = _d[1];
