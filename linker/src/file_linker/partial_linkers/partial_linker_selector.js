(function (factory) {
    ...
    var PartialLinkerSelector = /** @class */ (function () {
        function PartialLinkerSelector(options) {
             ...
             *
             * Finally, note that we always start with the current version (i.e. `11.1.0-next.4+1.sha-13020f9`). This
             * allows the linker to work on local builds effectively.
             */
            this.linkers = (_a = {},
                _a[exports.ɵɵngDeclareDirective] = [
                    { range: '11.1.0-next.4+1.sha-13020f9', linker: new partial_directive_linker_1_1.PartialDirectiveLinkerVersion1() },
                ...
                _a[exports.ɵɵngDeclareComponent] = [
                    { range: '11.1.0-next.4+1.sha-13020f9', linker: new partial_component_linker_1_1.PartialComponentLinkerVersion1(this.options) },
