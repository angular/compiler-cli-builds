(function (factory) {
     ...
     *
     * Finally, note that we always start with the current version (i.e. `11.1.0-next.4+47.sha-74175f8`). This
        ...
        PartialLinkerSelector.prototype.createLinkerMap = function (environment, sourceUrl, code) {
            ...
            return _a = {},
                _a[exports.ɵɵngDeclareDirective] = [
                    { range: '11.1.0-next.4+47.sha-74175f8', linker: partialDirectiveLinkerVersion1 },
                    { range: '>=11.1.0-next.1', linker: partialDirectiveLinkerVersion1 },
                ],
                _a[exports.ɵɵngDeclareComponent] = [
                    { range: '11.1.0-next.4+47.sha-74175f8', linker: partialComponentLinkerVersion1 },
