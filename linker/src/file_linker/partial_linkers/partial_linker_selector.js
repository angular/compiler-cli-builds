(function (factory) {
    ...
    var PartialLinkerSelector = /** @class */ (function () {
        function PartialLinkerSelector(options) {
             ...
             *
             * Finally, note that we always start with the current version (i.e. `11.1.0-next.3+27.sha-e4fbab9`). This
             * allows the linker to work on local builds effectively.
             */
            this.linkers = {
                'ɵɵngDeclareDirective': [
                    { range: '11.1.0-next.3+27.sha-e4fbab9', linker: new partial_directive_linker_1_1.PartialDirectiveLinkerVersion1() },
                    { range: '>=11.1.0-next.1', linker: new partial_directive_linker_1_1.PartialDirectiveLinkerVersion1() },
                ],
                'ɵɵngDeclareComponent': [
                    { range: '11.1.0-next.3+27.sha-e4fbab9', linker: new partial_component_linker_1_1.PartialComponentLinkerVersion1(this.options) },
