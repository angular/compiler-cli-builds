    ...
    var PartialComponentLinkerVersion1 = /** @class */ (function () {
        ...
        PartialComponentLinkerVersion1.prototype.toR3ComponentMeta = function (metaObj) {
            ...
            if (metaObj.has('components')) {
                directives.push.apply(directives, tslib_1.__spread(collectUsedDirectives(metaObj.getArray('components'))));
            }
            if (metaObj.has('directives')) {
                directives.push.apply(directives, tslib_1.__spread(collectUsedDirectives(metaObj.getArray('directives'))));
            }
            var pipes = new Map();
