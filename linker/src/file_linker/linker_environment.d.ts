...
export declare class LinkerEnvironment<TStatement, TExpression> {
    ...
    private constructor();
    static create<TStatement, TExpression>(fileSystem: FileSystem, logger: Logger, host: AstHost<TExpression>, factory: AstFactory<TStatement, TExpression>, options: Partial<LinkerOptions>): LinkerEnvironment<TStatement, TExpression>;
}
