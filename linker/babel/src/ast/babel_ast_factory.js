(function (factory) {
    ...
    var BabelAstFactory = /** @class */ (function () {
        ...
        BabelAstFactory.prototype.createFunctionDeclaration = function (functionName, parameters, body) {
            (0, linker_1.assert)(body, t.isBlockStatement, 'a block');
