...
export { type TypeCheckingConfig, type TcbComponentMetadata, type TcbTypeCheckBlockMetadata, type TcbTypeParameter, type TypeCheckId, type TcbDirectiveMetadata, type TemplateDiagnostic, type TcbReferenceMetadata, type SourceMapping, type OutOfBandDiagnosticRecorder, type DomSchemaChecker, type SymbolReference, OutOfBandDiagnosticCategory, SymbolKind, } from '../src/ngtsc/typecheck/api';
