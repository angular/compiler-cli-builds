    ...
    var InlineResourcesMetadataTransformer = /** @class */ (function () {
        ...
        InlineResourcesMetadataTransformer.prototype.start = function (sourceFile) {
            ...
            return function (value, node) {
                if ((0, index_1.isClassMetadata)(value) && ts.isClassDeclaration(node) && value.decorators) {
                    value.decorators.forEach(function (d) {
                        if ((0, index_1.isMetadataSymbolicCallExpression)(d) &&
                            (0, index_1.isMetadataImportedSymbolReferenceExpression)(d.expression) &&
        ...
        InlineResourcesMetadataTransformer.prototype.updateDecoratorMetadata = function (loader, arg) {
            ...
            styles.push.apply(styles, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(styleUrls.map(function (styleUrl) { return loader.get(styleUrl); })), false));
            if (styles.length > 0) {
                arg['styles'] = styles;
        ...
        componentArg.properties.forEach(function (prop) {
            ...
            switch (prop.name.text) {
                case 'styles':
                    ...
                    newStyleExprs.push.apply(newStyleExprs, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(prop.initializer.elements), false));
                    break;
                case 'styleUrls':
                    if (!ts.isArrayLiteralExpression(prop.initializer)) {
                        throw new Error('styleUrls takes an array argument');
                    }
                    newStyleExprs.push.apply(newStyleExprs, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(prop.initializer.elements.map(function (expr) {
