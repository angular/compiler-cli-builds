...
(function (factory) {
    ...
    function transformSourceFile(sourceFile, requests, context) {
        ...
        var min = Math.min.apply(Math, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(locations), false));
        var max = Math.max.apply(Math, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(locations), false));
        ...
        function visitSourceFile(sourceFile) {
            ...
            if (inserts.length) {
                ...
                /* modifiers */ undefined, ts.createNamedExports(inserts
                    .reduce(function (accumulator, insert) { return (0, tslib_1.__spreadArray)((0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(accumulator), false), (0, tslib_1.__read)(insert.declarations), false); }, [])
    ...
    function isRewritten(value) {
        return (0, index_1.isMetadataGlobalReferenceExpression)(value) && (0, compiler_1.isLoweredSymbol)(value.name);
    }
    ...
    var LowerMetadataTransform = /** @class */ (function () {
        ...
        LowerMetadataTransform.prototype.start = function (sourceFile) {
            var _this = this;
            var identNumber = 0;
            var freshIdent = function () { return (0, compiler_1.createLoweredSymbol)(identNumber++); };
        ...
        ts.forEachChild(sourceFile, function scan(node) {
            ...
            switch (node.kind) {
                ...
                case ts.SyntaxKind.VariableStatement:
                    ...
                    try {
                        for (var _b = (0, tslib_1.__values)(variableStatement.declarationList.declarations), _c = _b.next(); !_c.done; _c = _b.next()) {
