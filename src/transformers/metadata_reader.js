...
(function (factory) {
    ...
    function upgradeMetadataWithDtsData(host, oldMetadata, dtsFilePath) {
        ...
        var newMetadata = {
            ...
            'metadata': (0, tslib_1.__assign)({}, oldMetadata.metadata),
        };
