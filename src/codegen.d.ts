...
export declare class CodeGenerator {
    ...
    codegen(): Promise<any>;
    static create(options: AngularCompilerOptions, program: ts.Program, compilerHost: ts.CompilerHost, reflectorHostContext?: ReflectorHostContext, xhr?: compiler.XHR): CodeGenerator;
}
