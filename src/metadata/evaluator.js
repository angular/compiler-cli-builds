...
(function (factory) {
    ...
    function recordMapEntry(entry, node, nodeMap, sourceFile) {
        if (!nodeMap.has(entry)) {
            ...
            if (node &&
                ((0, schema_1.isMetadataImportedSymbolReferenceExpression)(entry) ||
                    (0, schema_1.isMetadataImportDefaultReference)(entry)) &&
                entry.line == null) {
    ...
    function errorSymbol(message, node, context, sourceFile) {
        var result = (0, tslib_1.__assign)({ __symbolic: 'error', message: message }, sourceInfo(node, sourceFile));
        if (context) {
    ...
    var Evaluator = /** @class */ (function () {
        ...
        Evaluator.prototype.nameOf = function (node) {
            ...
            if ((0, schema_1.isMetadataError)(result) || typeof result === 'string') {
                return result;
            }
            else {
        ...
        Evaluator.prototype.evaluateNode = function (node, preferReference) {
            ...
            function recordEntry(entry, node) {
                if (t.options.substituteExpression) {
                    ...
                    if (t.recordExport && newEntry != entry && (0, schema_1.isMetadataGlobalReferenceExpression)(newEntry)) {
            ...
            function isFoldableError(value) {
                return !t.options.verboseInvalidExpression && (0, schema_1.isMetadataError)(value);
            }
            var resolveName = function (name, preferReference) {
                ...
                if (reference && (0, schema_1.isMetadataSymbolicReferenceExpression)(reference)) {
                    return recordEntry((0, tslib_1.__assign)({}, reference), node);
                }
                return reference;
            };
            switch (node.kind) {
                ...
                case ts.SyntaxKind.ArrayLiteralExpression:
                    ...
                    ts.forEachChild(node, function (child) {
                        ...
                        if ((0, schema_1.isMetadataSymbolicSpreadExpression)(value)) {
                            if (Array.isArray(value.expression)) {
                                try {
                                    for (var _b = (0, tslib_1.__values)(value.expression), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                case ts.SyntaxKind.NewExpression:
                    ...
                    if ((0, schema_1.isMetadataError)(newTarget)) {
                ...
                case ts.SyntaxKind.PropertyAccessExpression: {
                    ...
                    if ((0, schema_1.isMetadataModuleReferenceExpression)(expression_1)) {
                ...
                case ts.SyntaxKind.TypeReference:
                    ...
                    var getReference = function (node) {
                        if (typeNameNode_1.kind === ts.SyntaxKind.QualifiedName) {
                            ...
                            if ((0, schema_1.isMetadataModuleReferenceExpression)(left_1)) {
                                return recordEntry({
                            ...
                            if (isFoldableError(symbol) || (0, schema_1.isMetadataSymbolicReferenceExpression)(symbol)) {
                    ...
                    if (!(0, schema_1.isMetadataModuleReferenceExpression)(typeReference) &&
                ...
                case ts.SyntaxKind.UnionType:
                    ...
                    for (var i = 0; i < references.length; i++) {
                        ...
                        if ((0, schema_1.isMetadataSymbolicReferenceExpression)(reference)) {
                            if (candidate) {
...
//# sourceMappingURL=data:application/json;base64,