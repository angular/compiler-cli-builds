                            ...
                            switch (bindings.kind) {
                                case ts.SyntaxKind.NamedImports:
                                    try {
                                        ...
                                        for (var _b = (0, tslib_1.__values)(bindings.elements), _c = _b.next(); !_c.done; _c = _b.next()) {
