    ...
    var MetadataBundler = /** @class */ (function () {
        ...
        MetadataBundler.prototype.exportAll = function (moduleName) {
            ...
            if (module && module.metadata) {
                for (var key in module.metadata) {
                    ...
                    if ((0, schema_1.isMetadataImportedSymbolReferenceExpression)(data)) {
            ...
            if (module && module.exports) {
                ...
                try {
                    for (var _d = (0, tslib_1.__values)(module.exports), _e = _d.next(); !_e.done; _e = _d.next()) {
                        ...
                        if (exportDeclaration.export) {
                            try {
                                ...
                                for (var _f = (e_2 = void 0, (0, tslib_1.__values)(exportDeclaration.export)), _g = _f.next(); !_g.done; _g = _f.next()) {
                            ...
                            try {
                                for (var exportedSymbols_1 = (e_3 = void 0, (0, tslib_1.__values)(exportedSymbols_2)), exportedSymbols_1_1 = exportedSymbols_1.next(); !exportedSymbols_1_1.done; exportedSymbols_1_1 = exportedSymbols_1.next()) {
        ...
        MetadataBundler.prototype.getEntries = function (exportedSymbols) {
            ...
            symbolsMap.forEach(function (names, identifier) {
                if (names.length > 1) {
                    var _a = (0, tslib_1.__read)(identifier.split(':'), 2), module_1 = _a[0], declaredName = _a[1];
        ...
        MetadataBundler.prototype.getReExports = function (exportedSymbols) {
            ...
            try {
                for (var exportedSymbols_3 = (0, tslib_1.__values)(exportedSymbols), exportedSymbols_3_1 = exportedSymbols_3.next(); !exportedSymbols_3_1.done; exportedSymbols_3_1 = exportedSymbols_3.next()) {
            ...
            return (0, tslib_1.__spreadArray)((0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(Array.from(exportAlls.values()).map(function (from) { return ({ from: from }); })), false), (0, tslib_1.__read)(Array.from(modules.entries()).map(function (_a) {
                var _b = (0, tslib_1.__read)(_a, 2), from = _b[0], exports = _b[1];
        ...
        MetadataBundler.prototype.convertEntry = function (moduleName, value) {
            if ((0, schema_1.isClassMetadata)(value)) {
                return this.convertClass(moduleName, value);
            }
            if ((0, schema_1.isFunctionMetadata)(value)) {
                return this.convertFunction(moduleName, value);
            }
            if ((0, schema_1.isInterfaceMetadata)(value)) {
                return value;
            }
        ...
        MetadataBundler.prototype.convertMember = function (moduleName, member) {
            ...
            if ((0, schema_1.isMethodMetadata)(member)) {
                ...
                if ((0, schema_1.isConstructorMetadata)(member)) {
        ...
        MetadataBundler.prototype.convertStatics = function (moduleName, statics) {
            ...
            for (var key in statics) {
                ...
                else if ((0, schema_1.isMetadataSymbolicCallExpression)(value)) {
        ...
        MetadataBundler.prototype.convertValue = function (moduleName, value) {
            ...
            if ((0, schema_1.isMetadataError)(value)) {
                return this.convertError(moduleName, value);
            }
            if ((0, schema_1.isMetadataSymbolicExpression)(value)) {
        ...
        MetadataBundler.prototype.convertReference = function (moduleName, value) {
            ...
            if ((0, schema_1.isMetadataGlobalReferenceExpression)(value)) {
            ...
            if ((0, schema_1.isMetadataImportedSymbolReferenceExpression)(value)) {
            ...
            if ((0, schema_1.isMetadataModuleReferenceExpression)(value)) {
