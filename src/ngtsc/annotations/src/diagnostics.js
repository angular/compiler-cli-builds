...
(function (factory) {
    ...
    function createValueHasWrongTypeError(node, value, messageText) {
        ...
        if (value instanceof partial_evaluator_1.DynamicValue) {
            ...
            relatedInformation = (0, partial_evaluator_1.traceDynamicValue)(node, value);
        }
            ...
            var referenceNode = (_a = (0, typescript_1.identifierOfNode)(value.node)) !== null && _a !== void 0 ? _a : value.node;
            relatedInformation = [(0, diagnostics_1.makeRelatedInformation)(referenceNode, 'Reference is declared here.')];
        }
        else {
            chainedMessage = "Value is of type '" + (0, partial_evaluator_1.describeResolvedType)(value) + "'.";
        }
        var chain = {
    ...
    function getProviderDiagnostics(providerClasses, providersDeclaration, registry) {
        ...
        var diagnostics = [];
        try {
            for (var providerClasses_1 = (0, tslib_1.__values)(providerClasses), providerClasses_1_1 = providerClasses_1.next(); !providerClasses_1_1.done; providerClasses_1_1 = providerClasses_1.next()) {
                ...
                diagnostics.push((0, diagnostics_1.makeDiagnostic)(diagnostics_1.ErrorCode.UNDECORATED_PROVIDER, contextNode, "The class '" + provider.node.name
                    ...
                    .text + "', or configure a different provider (such as a provider with 'useFactory').\n", [(0, diagnostics_1.makeRelatedInformation)(provider.node, "'" + provider.node.name.text + "' is declared here.")]));
            }
        }
    ...
    function getDirectiveDiagnostics(node, reader, evaluator, reflector, scopeRegistry, kind) {
        ...
        var addDiagnostics = function (more) {
            if (more === null) {
                ...
                diagnostics.push.apply(diagnostics, (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(more), false));
            }
            else {
        ...
        if (duplicateDeclarations !== null) {
            addDiagnostics((0, util_1.makeDuplicateDeclarationError)(node, duplicateDeclarations, kind));
        }
    ...
    function getUndecoratedClassWithAngularFeaturesDiagnostic(node) {
        return (0, diagnostics_1.makeDiagnostic)(diagnostics_1.ErrorCode.UNDECORATED_CLASS_USING_ANGULAR_FEATURES, node.name, "Class is using Angular features but is not decorated. Please add an explicit " +
            "Angular decorator.");
    }
    ...
    function checkInheritanceOfDirective(node, reader, reflector, evaluator) {
        ...
        var baseClass = (0, util_1.readBaseClass)(node, reflector, evaluator);
        while (baseClass !== null) {
            ...
            var newParentClass = (0, util_1.readBaseClass)(baseClass.node, reflector, evaluator);
    ...
    function getInheritedUndecoratedCtorDiagnostic(node, baseClass, reader) {
        ...
        return (0, diagnostics_1.makeDiagnostic)(diagnostics_1.ErrorCode.DIRECTIVE_INHERITS_UNDECORATED_CTOR, node.name, "The " + dirOrComp.toLowerCase() + " " + node.name.text + " inherits its constructor from " + baseClassName + ", " +
            "but the latter does not have an Angular decorator of its own. Dependency injection will not be able to " +
            ("resolve the parameters of " + baseClassName + "'s constructor. Either add a @Directive decorator ") +
            ("to " + baseClassName + ", or add an explicit constructor to " + node.name.text + "."));
    }
});
//# sourceMappingURL=data:application/json;base64,