(function (factory) {
    ...
    var FactoryGenerator = /** @class */ (function () {
        ...
        FactoryGenerator.prototype.generateShimForFile = function (sf, genFilePath) {
            var absoluteSfPath = (0, file_system_1.absoluteFromSourceFile)(sf);
            var relativePathToSource = './' + (0, file_system_1.basename)(sf.fileName).replace(TS_DTS_SUFFIX, '');
            ...
            if (symbolNames.length > 0) {
                ...
                sourceText += (0, tslib_1.__spreadArray)([
                ...
                ], (0, tslib_1.__read)(varLines), false).join('\n');
            }
            ...
            if (sf.moduleName !== undefined) {
                genFile.moduleName = (0, util_1.generatedModuleName)(sf.moduleName, sf.fileName, '.ngfactory');
            }
    ...
    function transformFactorySourceFile(factoryMap, context, importRewriter, file) {
        ...
        try {
            ...
            for (var _c = (0, tslib_1.__values)(file.statements), _d = _c.next(); !_d.done; _d = _c.next()) {
                var stmt = _d.value;
