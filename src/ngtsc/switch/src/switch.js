...
(function (factory) {
    ...
    function flipIvySwitchInFile(sf) {
        ...
        for (var i = 0; i < sf.statements.length; i++) {
            ...
            if (newStatements === undefined) {
                newStatements = (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(sf.statements), false);
            }
    ...
    function findPostSwitchIdentifier(statements, name) {
        var e_1, _a;
        try {
            for (var statements_1 = (0, tslib_1.__values)(statements), statements_1_1 = statements_1.next(); !statements_1_1.done; statements_1_1 = statements_1.next()) {
    ...
    function flipIvySwitchesInVariableStatement(stmt, statements) {
        ...
        // identifier.
        var newDeclarations = (0, tslib_1.__spreadArray)([], (0, tslib_1.__read)(stmt.declarationList.declarations), false);
