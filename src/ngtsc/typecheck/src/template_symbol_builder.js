...
(function (factory) {
    ...
    var SymbolBuilder = /** @class */ (function () {
        ...
        SymbolBuilder.prototype.getSymbolOfElement = function (element) {
            ...
            var node = (0, comments_1.findFirstMatchingNode)(this.typeCheckBlock, { withSpan: elementSourceSpan, filter: ts.isVariableDeclaration });
            if (node === null) {
                return null;
            }
            ...
            return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, symbolFromDeclaration), { kind: api_1.SymbolKind.Element, directives: directives, templateNode: element });
        };
        SymbolBuilder.prototype.getDirectivesOfNode = function (element) {
            ...
            var nodes = (0, comments_1.findAllMatchingNodes)(this.typeCheckBlock, { withSpan: elementSourceSpan, filter: isDirectiveDeclaration });
            return nodes
                .map(function (node) {
                var _a;
                var symbol = _this.getSymbolOfTsNode(node.parent);
                if (symbol === null || !(0, typescript_1.isSymbolWithValueDeclaration)(symbol.tsSymbol) ||
                ...
                var directiveSymbol = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, symbol), { tsSymbol: symbol.tsSymbol, selector: meta.selector, isComponent: isComponent, ngModule: ngModule, kind: api_1.SymbolKind.Directive, isStructural: meta.isStructural });
        ...
        SymbolBuilder.prototype.getSymbolOfBoundEvent = function (eventBinding) {
            ...
            var outputFieldAccesses = (0, comments_1.findAllMatchingNodes)(this.typeCheckBlock, { withSpan: eventBinding.keySpan, filter: filter });
            var bindings = [];
            try {
                for (var outputFieldAccesses_1 = (0, tslib_1.__values)(outputFieldAccesses), outputFieldAccesses_1_1 = outputFieldAccesses_1.next(); !outputFieldAccesses_1_1.done; outputFieldAccesses_1_1 = outputFieldAccesses_1.next()) {
        ...
        SymbolBuilder.prototype.getSymbolOfInputBinding = function (binding) {
            ...
            var nodes = (0, comments_1.findAllMatchingNodes)(this.typeCheckBlock, { withSpan: binding.sourceSpan, filter: typescript_1.isAssignment });
            var bindings = [];
            try {
                for (var nodes_1 = (0, tslib_1.__values)(nodes), nodes_1_1 = nodes_1.next(); !nodes_1_1.done; nodes_1_1 = nodes_1.next()) {
                    ...
                    bindings.push((0, tslib_1.__assign)((0, tslib_1.__assign)({}, symbolInfo), { tsSymbol: symbolInfo.tsSymbol, kind: api_1.SymbolKind.Binding, target: target }));
                }
            }
        ...
        SymbolBuilder.prototype.getDirectiveSymbolForAccessExpression = function (node, _a) {
            ...
            var _c = (0, tslib_1.__read)(tsSymbol.declarations, 1), declaration = _c[0];
        ...
        SymbolBuilder.prototype.getSymbolOfVariable = function (variable) {
            var node = (0, comments_1.findFirstMatchingNode)(this.typeCheckBlock, { withSpan: variable.sourceSpan, filter: ts.isVariableDeclaration });
        ...
        SymbolBuilder.prototype.getSymbolOfReference = function (ref) {
            ...
            var node = (0, comments_1.findFirstMatchingNode)(this.typeCheckBlock, { withSpan: ref.sourceSpan, filter: ts.isVariableDeclaration });
        ...
        SymbolBuilder.prototype.getSymbolOfPipe = function (expression) {
            var methodAccess = (0, comments_1.findFirstMatchingNode)(this.typeCheckBlock, { withSpan: expression.nameSpan, filter: ts.isPropertyAccessExpression });
            ...
            if (pipeInstance === null || !(0, typescript_1.isSymbolWithValueDeclaration)(pipeInstance.tsSymbol)) {
                return null;
            }
            ...
            return (0, tslib_1.__assign)((0, tslib_1.__assign)({ kind: api_1.SymbolKind.Pipe }, symbolInfo), { classSymbol: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, pipeInstance), { tsSymbol: pipeInstance.tsSymbol }) });
        };
        SymbolBuilder.prototype.getSymbolOfTemplateExpression = function (expression) {
            ...
            if (expression instanceof compiler_1.PropertyRead) {
                node = (0, comments_1.findFirstMatchingNode)(this.typeCheckBlock, { withSpan: withSpan, filter: ts.isPropertyAccessExpression });
            }
            // Otherwise fall back to searching for any AST node.
            if (node === null) {
                node = (0, comments_1.findFirstMatchingNode)(this.typeCheckBlock, { withSpan: withSpan, filter: anyNodeFilter });
            }
            if (node === null) {
                return null;
            }
            ...
            if ((expression instanceof compiler_1.SafePropertyRead ||
                ...
                return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, whenTrueSymbol), { kind: api_1.SymbolKind.Expression, 
                ...
                return symbolInfo === null ? null : (0, tslib_1.__assign)((0, tslib_1.__assign)({}, symbolInfo), { kind: api_1.SymbolKind.Expression });
            }
        };
