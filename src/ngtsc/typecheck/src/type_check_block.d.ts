 ...
 */
export declare function generateTypeCheckBlock(node: ClassDeclaration<ts.ClassDeclaration>, meta: TypeCheckBlockMetadata, importManager: ImportManager, refEmitter: ReferenceEmitter): ts.FunctionDeclaration;
