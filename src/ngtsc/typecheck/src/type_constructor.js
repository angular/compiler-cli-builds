...
(function (factory) {
        ...
        try {
            for (var keys_1 = (0, tslib_1.__values)(keys), keys_1_1 = keys_1.next(); !keys_1_1.done; keys_1_1 = keys_1.next()) {
                ...
                if (!meta.coercedInputFields.has(key)) {
                    ...
                    /* name */ key, 
                    /* questionToken */ undefined, 
                    /* type */ (0, ts_util_1.tsCreateTypeQueryForCoercedInput)(rawType.typeName, key), 
    ...
    function requiresInlineTypeCtor(node, host) {
        ...
        return !(0, tcb_util_1.checkIfGenericTypeBoundsAreContextFree)(node, host);
    }
