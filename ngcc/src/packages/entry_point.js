(function (factory) {
    ...
    function sniffModuleFormat(fs, sourceFilePath) {
        var resolvedPath = (0, utils_1.resolveFileWithPostfixes)(fs, sourceFilePath, ['', '.js', '/index.js']);
        ...
        else if ((0, umd_host_1.parseStatementForUmdModule)(sourceFile.statements[0]) !== null) {
            return 'umd';
        }
        else {
            return 'commonjs';
    ...
    function mergeConfigAndPackageJson(fs, entryPointPackageJson, entryPointConfig, packagePath, entryPointPath) {
        if (entryPointPackageJson !== null) {
            return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, entryPointPackageJson), entryPointConfig.override);
        }
        else {
            var name = fs.basename(packagePath) + "/" + fs.relative(packagePath, entryPointPath);
            return (0, tslib_1.__assign)({ name: name }, entryPointConfig.override);
        }
    }
    function guessTypingsFromPackageJson(fs, entryPointPath, entryPointPackageJson) {
        var e_1, _a;
        try {
            for (var SUPPORTED_FORMAT_PROPERTIES_1 = (0, tslib_1.__values)(exports.SUPPORTED_FORMAT_PROPERTIES), SUPPORTED_FORMAT_PROPERTIES_1_1 = SUPPORTED_FORMAT_PROPERTIES_1.next(); !SUPPORTED_FORMAT_PROPERTIES_1_1.done; SUPPORTED_FORMAT_PROPERTIES_1_1 = SUPPORTED_FORMAT_PROPERTIES_1.next()) {
