...
export declare function analyzeDecorators(classSymbol: NgccClassSymbol, decorators: Decorator[] | null, handlers: DecoratorHandler<any, any>[], flags?: HandlerFlags): AnalyzedClass | null;
