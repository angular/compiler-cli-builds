...
(function (factory) {
    ...
    var UmdReflectionHost = /** @class */ (function (_super) {
        (0, tslib_1.__extends)(UmdReflectionHost, _super);
        ...
        UmdReflectionHost.prototype.getImportOfIdentifier = function (id) {
            ...
            var nsIdentifier = (0, commonjs_umd_utils_1.findNamespaceOfIdentifier)(id);
        ...
        UmdReflectionHost.prototype.getDeclarationOfIdentifier = function (id) {
            ...
            var outerNode = (0, esm2015_host_1.getOuterNodeFromInnerDeclaration)(superDeclaration.node);
            if (outerNode === null) {
                return superDeclaration;
            }
            // We are only interested if the outer declaration is of the form
            // `exports.<name> = <initializer>`.
            if (!(0, commonjs_umd_utils_1.isExportsAssignment)(outerNode)) {
                return superDeclaration;
            }
            return {
                kind: 1 /* Inline */,
        ...
        UmdReflectionHost.prototype.getClassSymbolFromOuterDeclaration = function (declaration) {
            ...
            if (!(0, commonjs_umd_utils_1.isExportsDeclaration)(declaration)) {
                return undefined;
            }
            var initializer = (0, commonjs_umd_utils_1.skipAliases)(declaration.parent.right);
            ...
            var innerDeclaration = (0, esm2015_host_1.getInnerClassDeclaration)(initializer);
        ...
        UmdReflectionHost.prototype.getClassSymbolFromInnerDeclaration = function (declaration) {
            ...
            if (outerNode === null || !(0, commonjs_umd_utils_1.isExportsAssignment)(outerNode)) {
                return undefined;
            }
        ...
        UmdReflectionHost.prototype.addClassSymbolsFromStatement = function (classes, statement) {
            ...
            if ((0, commonjs_umd_utils_1.isExportsStatement)(statement)) {
        ...
        UmdReflectionHost.prototype.preprocessStatement = function (statement) {
            ...
            if (!(0, esm2015_host_1.isAssignment)(initializer) || !ts.isIdentifier(initializer.left) ||
        ...
        UmdReflectionHost.prototype.computeExportsOfUmdModule = function (sourceFile) {
            ...
            try {
                for (var _c = (0, tslib_1.__values)(this.getModuleStatements(sourceFile)), _d = _c.next(); !_d.done; _d = _c.next()) {
                    ...
                    else if ((0, commonjs_umd_utils_1.isWildcardReexportStatement)(statement)) {
                        var reexports = this.extractUmdWildcardReexports(statement, sourceFile);
                        try {
                            for (var reexports_1 = (e_2 = void 0, (0, tslib_1.__values)(reexports)), reexports_1_1 = reexports_1.next(); !reexports_1_1.done; reexports_1_1 = reexports_1.next()) {
                    ...
                    else if ((0, commonjs_umd_utils_1.isDefinePropertyReexportStatement)(statement)) {
        ...
        UmdReflectionHost.prototype.extractBasicUmdExportDeclaration = function (statement) {
            ...
            var exportExpression = (0, commonjs_umd_utils_1.skipAliases)(statement.expression.right);
        ...
        UmdReflectionHost.prototype.extractUmdWildcardReexports = function (statement, containingFile) {
            ...
            var requireCall = (0, commonjs_umd_utils_1.isRequireCall)(reexportArg) ?
                reexportArg :
                ts.isIdentifier(reexportArg) ? (0, commonjs_umd_utils_1.findRequireCallReference)(reexportArg, this.checker) : null;
            var importPath = null;
            if (requireCall !== null) {
            ...
            var viaModule = (0, utils_1.stripExtension)(importedFile.fileName);
            var reexports = [];
            importedExports.forEach(function (decl, name) { return reexports.push({ name: name, declaration: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, decl), { viaModule: viaModule }) }); });
            return reexports;
        };
        UmdReflectionHost.prototype.extractUmdDefinePropertyExportDeclaration = function (statement) {
            ...
            var getterFnExpression = (0, commonjs_umd_utils_1.extractGetterFnExpression)(statement);
        ...
        UmdReflectionHost.prototype.getUmdDeclaration = function (id) {
            ...
            if (nsIdentifier.parent.parent && (0, commonjs_umd_utils_1.isExportsAssignment)(nsIdentifier.parent.parent)) {
                ...
                return this.detectKnownDeclaration({
                    ...
                    implementation: (0, commonjs_umd_utils_1.skipAliases)(nsIdentifier.parent.parent.right),
                    viaModule: null,
                    known: null,
                });
            }
            ...
            return (0, tslib_1.__assign)((0, tslib_1.__assign)({}, declaration), { viaModule: viaModule, known: (0, utils_1.getTsHelperFnFromIdentifier)(id) });
        };
        ...
        UmdReflectionHost.prototype.getUmdModuleDeclaration = function (id) {
            ...
            var viaModule = (0, commonjs_umd_utils_1.isExternalImport)(importPath) ? importPath : null;
        ...
        UmdReflectionHost.prototype.getImportPathFromRequireCall = function (id) {
            var requireCall = (0, commonjs_umd_utils_1.findRequireCallReference)(id, this.checker);
            if (requireCall === null) {
                return null;
            }
        ...
        UmdReflectionHost.prototype.getDeclarationOfExpression = function (expression) {
            var inner = (0, esm2015_host_1.getInnerClassDeclaration)(expression);
            if (inner !== null) {
                var outer = (0, esm2015_host_1.getOuterNodeFromInnerDeclaration)(inner);
                if (outer !== null && (0, commonjs_umd_utils_1.isExportsAssignment)(outer)) {
                    return {
                        kind: 1 /* Inline */,
                        node: outer.left,
        ...
        UmdReflectionHost.prototype.resolveModuleName = function (moduleName, containingFile) {
            if (this.compilerHost.resolveModuleNames) {
                ...
                return moduleInfo && this.program.getSourceFile((0, file_system_1.absoluteFrom)(moduleInfo.resolvedFileName));
            }
            else {
                ...
                return moduleInfo.resolvedModule &&
                    this.program.getSourceFile((0, file_system_1.absoluteFrom)(moduleInfo.resolvedModule.resolvedFileName));
            }
        };
    ...
    function parseStatementForUmdModule(statement) {
        ...
        if (factoryFnParamIndex === -1)
            return null;
        var factoryFn = (0, utils_2.stripParentheses)(wrapperCall.arguments[factoryFnParamIndex]);
    ...
    function getRequiredModulePath(wrapperFn, paramIndex) {
        ...
        function findModulePaths(node) {
            if ((0, commonjs_umd_utils_1.isRequireCall)(node)) {
